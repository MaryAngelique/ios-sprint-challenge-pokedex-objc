...
class PokemonAPI: NSObject {
    ...
    @objc dynamic var pokemon: MAAPokemon? {
        didSet {
    ...
    @objc func fetchAllPokemon(completion: @escaping ([MAAPokemon]?, Error?) -> Void) {
        ...
        fetch(from: url) { (dictionary, error) in
            ...
            var pokemen: [MAAPokemon] = []
            for dictionary in pokemonDictionaries {
                if let pokemon = MAAPokemon(dictionary: dictionary) {
    ...
    @objc func fillInDetails(for pokemon: MAAPokemon) {
        self.pokemon = nil
        ...
        fetch(from: url) { (dictionary, error) in
            ...
            let possibleFullPokemon = MAAPokemon(dictionary: dictionary)
